...
public class DFSDungeon extends Dungeon implements DungeonActions {
    public DFSDungeon(String dungeonName, int dungeonSizeX, int dungeonSizeY, DungeonPointers generationLogic) {
